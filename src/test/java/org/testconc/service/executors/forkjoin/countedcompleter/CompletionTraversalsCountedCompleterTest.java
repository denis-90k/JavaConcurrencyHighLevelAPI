...
public class CompletionTraversalsCountedCompleterTest {
    @Test
    public void commonPoolTest() {
        ...
        CompletionTraversalsCountedCompleter rscc = new CompletionTraversalsCountedCompleter(null, lines, new MyMapper(), new MyReducer(), 0, lines.length, null);
        Map<String, List<Integer>> result = rscc.invoke().stream()
